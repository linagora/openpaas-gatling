...
import com.linagora.openpaas.gatling.Configuration.{CalendarCount, SabreBaseUrl}
import com.linagora.openpaas.gatling.calendar.CalendarConstants.{CalendarSpaName, ESNToken}
  ...
  def openCalendarSPA(): ChainBuilder = {
    group("openCalendarSPA") {
      exec(LoginSteps.loadLoginTemplates)
        ...
        .exec(StaticAssetsSteps.loadIndexHtmlAndMainJs(CalendarSpaName))
